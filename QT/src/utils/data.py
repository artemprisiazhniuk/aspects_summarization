...
class ReviewDataset(Dataset):
    ...
    def __init__(self, data, sample_size=None, spmodel=None, 
            max_sen_len=1000, max_rev_len=1000, entity_id_alias='id'):
        '''Parameters:
        ...
        for entity_data in data:
            entity_id = entity_data[entity_id_alias]
            ...
            for review_id, review_data in enumerate(entity_data['reviews']):
...
class ReviewSummarizationDataset(ReviewDataset):
    ...
    def __init__(self, data, sample_size=None, spmodel=None, 
            max_sen_len=1000, max_rev_len=1000, entity_id_alias='entity_id'):
        super(ReviewSummarizationDataset, self).__init__(data, sample_size,
                spmodel, max_sen_len, max_rev_len, entity_id_alias)
